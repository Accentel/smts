...
include 'PHPExcel-1.8/Classes/PHPExcel/Writer/Excel2007.php';
 $tsname=$_GET['user'];
	...
	if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts')or ($tsname=='naiduys') or  ($tsname=='sumanthpotluri') ){
...
while($row	=	$result->fetch_assoc()){
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('T'.$rowCount, (rtrim($array,',')));
