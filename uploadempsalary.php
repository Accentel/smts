                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">Upload Formats</a>
                            </li>
                            <li>
                                <a href="#">Upload Employee Salary</a>
                            </li>
                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">Upload Employees Salary</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="uploadempsal_suc.php" enctype="multipart/form-data" autocomplete="off">
