...
<input type="radio" id="male" name="gender" value="male">
  ...
  <label for="unmarried">unmarried</label>
                                    ...
                                    <tr>
                                    <!-- <td align="right">Employee ID</td><td align="left">
										<input type="text" class="form-control" required  id="employeeid" name="employeeid" placeholder="Enter Employee ID">
										</td> -->
                                        <td align="right">Station Code</td><td align="left">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="row" >
                                    <div class="col-xs-12" >
                                        ...
                                        <div class="table-header" style="text-align: center; background-color:#438EB9;">
                                                Employee List
                                        </div>
                                        ...
                                        <!-- div.dataTables_borderWrap -->
                                        <div style="Overflow-x:scroll; horizontal bar option in html Overflow-y:scroll;">
