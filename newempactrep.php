                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#">Employee Working Report</a>
                            </li>
...
echo  "<option value=\"$row2[indid]\"/>"; // Format for adding options 
}
...
echo  "<option value=\"$row3[sname]\"/>"; // Format for adding options 
}
////  End of data collection from table /// 
...
echo "</datalist>";?></datalist>
                        ...
                        <div class="col-sm-2">
						    <input id=\"uploadby\" list=\"uploadby26\" name="uploadby" class="form-control" placeholder="Name" >
<datalist id=\"uploadby26\" >

<?php  
$sql4="SELECT distinct uploadby FROM request";
  // Query to collect records
$r4=mysqli_query($link,$sql4) or die(mysqli_error());
while ($row4=mysqli_fetch_array($r4)) {
echo  "<option value=\"$row4[uploadby]\"/>"; // Format for adding options 
}
////  End of data collection from table /// 
...
echo "</datalist>";?></datalist>
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
									...
									(('$uploadby' <> ' ' and locate('$uploadby', uploadby) <> 0) or ('$uploadby' = ' '  and 1 = 1) ) ";  
