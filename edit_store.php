...
include('dbconnection/connection1.php');
						$id=$_GET['id'];
						 $y="select * from sites where id='$id' ";
...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="store_suc.php">
                                        ...
                                        <input type="text" name="stationid" id="stationid" value="<?php echo $r['stationid'];?>" required class="form-control">
                                        
                                       </td>
                                       <td align="right">Station Name</td><td>
                                        <input type="text" name="name" id="name" value="<?php echo $r['name'];?>" required class="form-control">
                                    ...
                                    <tr>
                                        ...
                                        <input type="text" name="coordinatorname" id="coordinatorname"  value="<?php echo $r['coordinatorname'];?>" class="form-control">
                                        
                                       </td>
                                        <td align="right">OM Manager </td><td>
                                        <input type="text" name="ommanagername" id="ommanagername" value="<?php echo $r['ommanagername'];?>" required class="form-control">
                                    ...
                                    <textarea name="area" id="area" class="form-control" ><?php echo $r['area'];?></textarea>
