...
if(isset($_POST['submit'])){
	...
	if(in_array($_FILES["file"]["type"],$mimes)){
			...
			$html.="<td>".$i."</td>";
				...
				if( $c > 0 ){
					//echo 'hi';
								...
								pfes='$pfes',location='$loc',bank_name='$bank',pf_no='$pf1',pf_uan='$uan',esi_no1='$esi1',ac_num='$ac',designation='$desg',bonus='$bonus',oben='$oben',doj='$doj'    where email='$email1' and month='$month1' and year='$year1' ";
	   ...
	   $query = "insert into salarymonthwise(name,email,basic,others,month,year,pf,pt,esi,pfec,pfes,location,bank_name,pf_no,pf_uan,esi_no1,ac_num,designation,bonus,oben,doj)
							values('".$ename."','".$empid."','".addslashes($basic)."','".$others."',
							'".$month."','".$year."','".$pf."','".$pt."','".$esi."',
							'".$pfec."','".$pfes."','".$loc."','".$bank."','".$pf1."','".$uan."','".$esi1."','".$ac."','".$desg."','".$bonus."','".$oben."','".$doj."')";     
