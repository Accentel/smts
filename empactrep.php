    ...
    echo "</datalist>";?>
        ...
        <th >
                                                                <div  style="width:100%">
    <span style="width:20%" onclick="populatefilters('empid26')" class=reload>&#x21bb;</span><input style="width:80%"  id=\"empid26\" list="empid26" name="empid26" class="form-control" placeholder="EMP Name" >
    </div>
                                                                
    <datalist id="empid26" >
    <?php  
    $sql4="SELECT distinct empid FROM request";
    // Query to collect records
    $r4=mysqli_query($link,$sql4) or die(mysqli_error());
    while ($row4=mysqli_fetch_array($r4)) {
    echo  "<option value=\"$row4[empid]\"/>";
    }
    echo "</datalist>";?>
    </datalist>
    </th>
