...
<b>                                                              To Date: <?php echo $to_date;?></b></p>
            ...
            <div class="form-actions" align="right">
                <div class="row">
                    <div class="col-md-5"  align="left  ">
                        <input type="submit" class="btn btn-info" name="bsearch" id="bsearch" value="check"  onclick="reportxx();">
    ...
    echo "</datalist>";?>
        ...
        <th >
                                                                <div  style="width:100%">
    <span style="width:20%" onclick="populatefilters('empid26')" class=reload>&#x21bb;</span><input style="width:80%"  id=\"empid26\" list="empid26" name="empid26" class="form-control" placeholder="Station ID" >
    </div>
    ...
    $emplist=$emplist.','."'".$emparray[$k]."'";
                                            ...
                                            $start_from = ($page-1) * $results_per_page;
                                                ...
                                                $y="select * from request where empid like '%$bsearch%' or sname like '%$bsearch%'  or indid like '%$bsearch%'order by id desc";
                                                    ...
                                                    (('$empid' <> ' ' and locate('$empid', empid) <> 0) or ('$empid' = ' '  and 1 = 1) ) ORDER BY id desc";
                                                        }
