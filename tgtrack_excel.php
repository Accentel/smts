...
while($row	=	$result->fetch_assoc()){
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('AK'.$rowCount, mb_strtoupper('TS','UTF-8'));
...
header('Content-Disposition: attachment;filename="tstrack.xlsx"'); //tell browser what's the file name
