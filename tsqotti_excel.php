...
$objPHPExcel->getActiveSheet()->setCellValue('I12',36);	
$objPHPExcel->getActiveSheet()->setCellValue('D13', $r['po_no']);
$objPHPExcel->getActiveSheet()->setCellValue('I11', Telangana);
$objPHPExcel->getActiveSheet()->setCellValue('I13', date('d-m-Y',strtotime($r['po_date'])));
$objPHPExcel->getActiveSheet()->setCellValue('C21', Telangana);
$objPHPExcel->getActiveSheet()->setCellValue('E21', 36);
