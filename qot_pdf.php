...
<tr><td colspan="2"><b>Fault Description:</b><?php echo $r['falt_desc'];?></td></tr>
 ...
 <table >
		...
		<?php echo $r1['address'];?><br/>
				<?php echo  $st=$r1['state']; if($st=='AP'){ echo "ANDHRA PRADESH "; } else if($st=='TG'){ echo "TELANGANA STATE"; }else if($st=='KN'){ echo "KARNATAKA STATE"; }?><br/>
			<?php echo $r1['gst_in'];?>
			</b>			
			</td>
		</tr>
...
<tr>
	<th  colspan="14" style="text-align:right;padding-right:10px;font-size:20px;"> For JTECHNO ASSOCIATES<br/><img src="sign.jpeg" height="70"/><br/>Authorised Signatory
</th>
</tr>
      </tbody>
    </table></td></tr></table>
