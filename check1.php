...
<b>                                                              To Date: <?php echo $to_date;?></b></p>
            ...
            <!-- <div class="form-actions" align="right">
                ...
                <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                                ...
                                                <th>   <input type="reset" value="Reset" name="submit1" class="btn btn-danger"  onclick="javascript:location.href='check2.php'"> </th>
                    </div> &nbsp; &nbsp;      &nbsp; &nbsp;
						...
						//   where datecheck between '$from_date' and '$to_date' ";
                                            ...
                                            $tdate=$_REQUEST['tdate'];
                                                    ...
                                                    (('$empid' <> ' ' and locate('$empid', empid) <> 0) or ('$empid' = ' '  and 1 = 1) )";
                                                        ...
                                                        // where datecheck between '$from_date' and '$to_date' an ORDER BY id desc LIMIT $start_from, $results_per_page";
                                                        $y="SELECT *FROM  request 
                                                        where datecheck between '$from_date' and '  '  ORDER BY id desc LIMIT $start_from, $results_per_page";
                                                    }
