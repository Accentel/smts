...
<div class="row">
 ...
 <form name="frm" method="post" id="register-form" action="store_suc.php">
                                        ...
                                        <td align="right">Station Code</td><td>
                                        <input type="text" name="stationid" id="stationid" required class="form-control">
                                        
                                       </td>
                                       <td align="right">Station Name</td><td>
                                        ...
                                        <!-- <td align="right">Company station  Name</td><td>
										<select name="comp_name" class="form-control">
										<option value="">Select Name</option> --> 
										<!-- <?php $sq=mysqli_query($link,"select * from sites order by name");
                                       ...
                                       <!-- </td>
										...
										<select name="coordinatorname" class="form-control">
										<option value="">Select Coordinator</option>
										<?php $sq=mysqli_query($link,"select * from sites order by coordinatorname");
										while($r=mysqli_fetch_array($sq)){?>
										<option value="<?php echo $r['coordinatorname'];?>"><?php echo $r['coordinatorname'];?></option>
										<?php }?>
										</select>
                                        
                                       </td>
                                        <td align="right">OM Manager</td><td>
                                        <!--<input type="text" name="afm" id="afm" required class="form-control">-->
										<select name="ommanagername" class="form-control" required>
										<option value="">Select OM manager</option>
										<?php $sq=mysqli_query($link,"select * from sites order by ommanagername");
										while($r=mysqli_fetch_array($sq)){?>
										<option value="<?php echo $r['ommanagername'];?>"><?php echo $r['ommanagername'];?></option>
										<?php }?>
										</select>
                                    ...
                                    <textarea name="area"  class="form-control" required></textarea>
										...
										while($r=mysqli_fetch_array($sq)){  ?> -->
										<!-- <option value=" -->
                                        <!-- <?php echo $r['name'];?>"><?php echo $r['name'];?> -->
                                    <!-- </option> -->
										<!-- <?php }?> -->
										<!-- </select> -->
