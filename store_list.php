...
<?php  
$sql2="SELECT distinct name FROM sites";
...
<?php  
$sql3="SELECT distinct stationid FROM sites";
  // Query to collect records
$r3=mysqli_query($link,$sql3) or die(mysqli_error());
while ($row3=mysqli_fetch_array($r3)) {
echo  "<option value=\"$row3[stationid]\"/>"; // Format for adding options 
}
////  End of data collection from table /// 
                                        ...
                                        <div>
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $state=$_POST['state'];
											   ...
											   $y="select  * from sites where
												
												
											(('$name' <> ' ' and locate('$name', name) <> 0) or ('$name' = ' '  and 1 = 1) ) and
											
									(('$stationid' <> ' ' and locate('$stationid', stationid) <> 0) or ('$stationid' = ' '  and 1 = 1) ) ";  
											    
									
											    
											}else{
											    $y="select * from sites order by id desc ";
											}
...
<!--<td class="center">
                                                        ...
                                                        <td class="hidden-480"><?php echo $rs1['stationid']; ?></td>
                                                        <td class="hidden-480"><?php echo $rs1['state']; ?></td>
                                                        
                                                        <td class="hidden-480"><?php echo $rs1['area'] ?></td>
