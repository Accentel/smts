...
<form method="post" action="" class="form-horizontal">
  ...
  <span style="width:20%" onclick="populatefilters('store_code26')" class=reload>&#x21bb;</span>
                                                            <input style="width:80%"  id=\"store_code\" list="store_code26" name="store_code" class="form-control" placeholder="Station Code" ></div>
<datalist id="store_code26" >
</datalist>
</th>
 <th >
                                                            <div  style="width:100%">
  <span style="width:20%" onclick="populatefilters('store_name26')" class=reload>&#x21bb;</span><input style="width:80%"  id=\"store_name\" list=store_name26 name="store_name" class="form-control" placeholder="Station Name">
</div>
...
<datalist id="store_name26" >
     ...
     <th >
                                                            <div  style="width:100%">
  <span style="width:20%" onclick="populatefilters('coordinator26')" class=reload>&#x21bb;</span><input style="width:80%"  id=\"coordinator\" list="coordinator26" name="coordinator" class="form-control" placeholder="Emp Name" >
</div>
 ...
 margin-top:5px;" onclick="javascript:location.href='qot_list1.php'">--> </th> <th></th><th></th>
                                        ...
                                        $start_from = ($page-1) * $results_per_page;
											...
											// $y="select a.store_name,a.city,b.quet_num,b.store_code,b.inv_date,b.id
											 ...
											 $y="select * from request where empid like '%$bsearch%' or phoneno like '%$bsearch%'  or indid like '%$bsearch%'order by id desc";
												} else
												if(isset($_POST['submitkk'])){
												//$qot_nun=$_POST['qot_nun'];
												$store_code=$_POST['indid'];
												$store_name=$_POST['sname'];
												$coordinator=$_POST['empid'];
												$superwisor=$_POST['uploadby'];
												$city=$_POST['phoneno'];	
												$status=$_POST['checkoutloc'];
												/*echo $y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id from add_qot a,dpr b where a.quet_num='$qot_nun'
												 ...
												 $y="select  a.indid,a.sname,a.empid,a.uploadby,a.id,a.phoneno from request a,request b where
