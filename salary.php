                        ...
                        <div class="row">
                            <div class="col-xs-6">
                               <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action=""  autocomplete="off" target="_blank">
                                   ...
                                   <!-- <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
											   ...
											   <?php $m=mysqli_query($conn,"select distinct name from salarymonthwise") or die(mysqli_error($link));
											   
														            while($m1=mysqli_fetch_array($m)){?>
														            <option value='<?php echo $m1['name'] ?>'><?php echo $m1['name'] ?></option>
														            <?php }; ?>
											    </select>
                                                                                       </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-4 col-md-8">
                                            <button class="btn btn-info" type="submit" name="submit" id="Update">
                                               ...
                                               <a href="salaryslip1.php"> Statement</a>
                                            </button>
