...
<html lang="en">
	...
	<body class="login-layout" style=" background-image: url('jyothi1.png');background-repeat: no-repeat;width:100%;height:100%;background-color:#bff2f7;background-position: top;">
