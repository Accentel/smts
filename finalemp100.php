...
xmlhttp.open("GET","getfilterinforpages.php?q="+str+"&statetable=request",true);
xmlhttp.send();
}
...
<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='finalemp2.php'" id="bsearch">   Add New  </button>
        ...
        <div class="form-group" style="margin-top: 10px;">
				...
				<!-- commeneting the colunm to use single form for the page  -->
						
                     <!-- <div class="col-sm-4">
                  
                <input type="text" class="form-control " id="search" name="search" placeholder="Search By Emp ID or Station Name or Station ID"/>
                  </div>
				   <div class="col-sm-3">
...
<form method="post" action="" class="form-horizontal">
  ...
  <span style="width:20%" onclick="populatefilters('store_code26')" class=reload>&#x21bb;</span>
                                                            <input style="width:80%"  id=\"uloadby\" list="store_code26" name="uploadby" class="form-control" placeholder="Employee Name" ></div>
<datalist id="store_code26" >
</datalist>
</th>
 <th >
                                                            <div  style="width:100%">
  <span style="width:20%" onclick="populatefilters('store_name26')" class=reload>&#x21bb;</span><input style="width:80%"  id=\"indid\" list=store_name26 name="indid" class="form-control" placeholder="Station code">
</div>
...
<datalist id="store_name26" >
     ...
     <th >
                                                            <div  style="width:100%">
  <span style="width:20%" onclick="populatefilters('coordinator26')" class=reload>&#x21bb;</span><input style="width:80%"  id=\"sname\" list="coordinator26" name="sname" class="form-control" placeholder="Station Address" >
</div>
    <!-- Unnecessary lists                                                         -->
...
<b>                                                              To Date: <?php echo $to_date;?></p>
<div class="col-sm-1" style="margin-left:50%"><b><a href="emp_rep.php" class="btn btn-primary btn-xs">XL Download</a></b></div>
</div>
                                                <tbody>
                                        ...
                                        $start_from = ($page-1) * $results_per_page;
                                            ...
                                            // $y="SELECT *FROM request WHERE (sname like '%$bsearch%') AND checkdate BETWEEN datecheck between '$from_date' and '$to_date'  ";		
												...
												$sname=$_POST['sname'];
												$indid=$_POST['indid'];
                                                // Commented Unnecessary field for in form table serach 
											...
											// 	}
												// Adding a search query as per the requirement 
                                                // working perfectly adding it as comment for backup
                                            ...
                                            // adding select only feature   ( removed feature)
...
$ssq1=mysqli_query($link,"select * from request where indid='$indid'");
