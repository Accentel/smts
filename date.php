                            ...
                            <div class="col-xs-6">
                               <div class="box box-info">
								<div class="box-header with-border">
								  <h3 class="box-title">Employee Activity Report</h3>
								</div>
                               
                                <form class="form-horizontal" id="validation-form" role="form" method="post" action="emp_final.php"  autocomplete="off" target="_blank">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Station Name </label>
                                               ...
                                               <select  id="id_name" name="id_name[]" multiple class="form-control" >
                                              
                                              <?php $m=mysqli_query($conn,"select distinct indid from request ") or die(mysqli_error($link));
                                              
                                                                   while($m1=mysqli_fetch_array($m)){?>
                                                                   <option value='<?php echo $m1['indid'] ?>'><?php echo $m1['indid'] ?></option>
                                                                   <?php }; ?>
                                               </select>
                                                                                      </div>                                               
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-4 col-md-8">
                                           ...
                                           <a href="dashboard.php"><button class="btn btn-danger" type="button" name="button" id="Close">
                                            ...
                                            <!-- <b><button class="btn btn-info" type="button" name="button" a href="emp_rep.php" class="btn btn-primary btn-xs">XL Download</a></button></b> -->
                                        </div>
                                    </div>
...
$(document).ready(function(){
 $('#id_name').multiselect({
  nonSelectedText: 'Select Station',
  enableFiltering: true,
  enableCaseInsensitiveFiltering: true,
  includeSelectAllOption: true,
